    ...
    <TooltipProvider>
      <div className="flex min-h-screen flex-col bg-background">
        <main className="flex-1 overflow-y-auto">
            <div className="p-4 sm:p-6 border-b flex justify-between items-center">
                <h1 className="text-xl font-semibold flex items-center gap-2">
                  <Image src="https://firstrateaugmentedintelligence.com/document-tracking/CUT_WhiteLogo.svg" alt="Cumberland Trust Logo" width={210} height={30} />
                  <span className="border-l pl-2 ml-2 text-muted-foreground text-lg">Dashboard - Document Tracking</span>
                </h1>
                <div className="flex items-center gap-2">
        ...
        />
          ...
          onOpenChange={(isOpen) => { if(!isOpen) setSelectedKpi(null)}}
        />
      </div>
    </TooltipProvider>
  );
